...
class CentralityAnalysis:
    def __init__(self, root):
        self.root = root
        self.root.title("Centrality Analysis")  # Imposta il titolo della finestra
        ...
        # Etichetta per la selezione del set da analizzare
        ...
        self.selected_set = ctk.StringVar()  # Variabile per memorizzare l'opzione selezionata

        # Menu a tendina per la selezione del set
        self.combobox_set = ctk.CTkComboBox(self.frame,
                                              ...
                                              width=200,
                                              font=("helvetica", 30),
                                              dropdown_font=("helvetica", 30))  # Imposta il font per i valori nel menu a tendina
        self.combobox_set.grid(row=0, column=1, padx=10, pady=10)
        self.combobox_set.set(self.sets[0])  # Imposta il valore predefinito del menu a tendina
