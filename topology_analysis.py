...
class TopologyAnalysis:
    def __init__(self, root):
        self.root = root
        self.root.title("Topology Analysis")  # Imposta il titolo della finestra
        ...
        # Checkbox per le metriche di analisi
    ...
    def open_metrics(self, metrics_class):
        # Apre una nuova finestra per l'analisi della metrica selezionata
