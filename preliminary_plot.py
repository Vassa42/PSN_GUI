...
class PreliminaryPlot:
    def __init__(self, root):
        ...
        self.button_min = ctk.CTkButton(self.frame, text="Confirm", font=("Helvetica", 30), command=self.update_min,
        ...
        self.button_max = ctk.CTkButton(self.frame, text="Confirm", font=("Helvetica", 30), command=self.update_max,
                                        width=200, height=40, fg_color="gray30")
        ...
        self.button_step = ctk.CTkButton(self.frame, text="Confirm", font=("Helvetica", 30), command=self.update_step,
                                         width=200, height=40, fg_color="gray30")
