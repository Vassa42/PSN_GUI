...
class PSNEvaluator:
    def __init__(self, root):
        self.root = root
        self.root.title("PSN Evaluator")  # Imposta il titolo della finestra
        ...
        # Crea un frame interno per i widget
        ...
        # Checkbox per selezionare le analisi
        ...
        # Etichetta per mostrare i risultati (attualmente vuota)
    ...
    # Funzione per la selezione del file macro_IIN
    ...
    # Funzione per la selezione del file di struttura
